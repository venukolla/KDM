package com.ibm.profile.scientists;
 ...
 *  @author Sean Welleck **/
public class ProfileIInsightsUserModelling 
{
	...
	public ProfileIInsightsUserModelling()
	{
		try {
	 ...
	 *  returned by Watson. **/
	public List<ResearchInterest> getReaserchScientistsList(String text)
	{
		List<ResearchInterest> traits = new ArrayList<ResearchInterest>();
		...
		for (Map<String, String> m : lm)
		{
			...
			if (id != null)
			{
				...
				if (val != null)
				{
					...
					traits.add(new ResearchInterest(id, pct));
				}
			}
		}
		return traits;
	...
	public String getPersonVizHTML(Scientist p)
	{
